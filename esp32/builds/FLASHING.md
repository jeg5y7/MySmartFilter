...
- **`smartfilter-usb-pilot-TEST-v1.7.8.bin`** — bench-test build. Needs no
...
- **`smartfilter-usb-pilot-v1.7.8.bin`** — real build for assembled units
...
## v1.7.8 — first successful end-to-end bench test
