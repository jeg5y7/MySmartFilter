...
export function FirmwareSchemaRepair({ detail }: { detail: string | null }) {
  ...
  return (
    <div className="bg-clay/10 border border-clay/30 rounded-2xl p-6">
      <h2 className="text-lg font-semibold text-clay mb-2">
        One-time setup needed
      </h2>
      <p className="text-sm text-body mb-4 max-w-xl">
      ...
      <button
        ...
        className="px-5 py-2.5 rounded-full bg-clay hover:bg-clay/85 disabled:opacity-50 text-white text-sm font-semibold transition-all"
      >
      ...
      {detail && (
        <p className="text-xs text-faint mt-4 font-mono break-all">
